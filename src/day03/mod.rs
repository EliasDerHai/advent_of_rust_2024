...
mod tests {
    ...
    use crate::day03::part2::solve_day_03_part_02;
    use crate::day03::part2_eager::solve_day_03_part_02_eager;
    ...
    fn should_be_equal() {
        ...
        let lazy = solve_day_03_part_02(input.bytes().map(|b| b as char));
        let eager = solve_day_03_part_02_eager(input);
